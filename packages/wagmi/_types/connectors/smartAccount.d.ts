...
export declare function smartAccount<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends SmartAccount = SmartAccount>({ smartAccountClient, id, name, type }: {
    ...
    getClient: ({ chainId: requestedChainId }: {
        ...
        extend: <const client extends {
            ...
            type?: undefined;
            uid?: undefined;
        } & import("viem").ExactPartial<Pick<import("viem").PublicActions<transport, chain, account>, "getChainId" | "prepareTransactionRequest" | "sendRawTransaction" | "call" | "createContractEventFilter" | "createEventFilter" | "estimateContractGas" | "estimateGas" | "getBlock" | "getBlockNumber" | "getContractEvents" | "getEnsText" | "getFilterChanges" | "getGasPrice" | "getLogs" | "getTransaction" | "getTransactionCount" | "getTransactionReceipt" | "readContract" | "simulateContract" | "uninstallFilter" | "watchBlockNumber" | "watchContractEvent"> & Pick<import("viem").WalletActions<chain, account>, "sendTransaction" | "writeContract">>>(fn: (client: import("viem").Client<transport, chain, account, import("permissionless/_types/types/bundler").BundlerRpcSchema, import("permissionless").SmartAccountActions<chain, account>>) => client) => import("viem").Client<transport, chain, account, import("permissionless/_types/types/bundler").BundlerRpcSchema, { [K_6 in keyof client]: client[K_6]; } & import("permissionless").SmartAccountActions<chain, account>>;
    } & {
